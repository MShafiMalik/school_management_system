...
<head>
  <meta charset="utf-8">
    ...
    <title>Supreme Standard - Log in </title>
                            ...
                            <form method="POST" action="{{ route('login') }}">
                                ...
                                <div class="form-group">
									<div class="input-group mb-3">
										...
										<input type="email" id="email" name="email" class="form-control pl-15 bg-transparent text-white plc-white" placeholder="Username" required autofocus>
									</div>
								</div>
								<div class="form-group">
									<div class="input-group mb-3">
										...
										<input type="password" name="password" id="password" class="form-control pl-15 bg-transparent text-white plc-white" placeholder="Password" required autocomplete="current-password">
									</div>
								</div>
								<div class="row">
									<div class="col-6">
